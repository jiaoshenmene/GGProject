Pod::Spec.new do |s|  
  ...
  #s.description      = <<-DESC  
   #                    It is a marquee view used on iOS, which implement by Objective-C.  
    #                   DESC  
  s.homepage         = "https://github.com/jiaoshenmene/GGProject"  
  # s.screenshots      = "www.example.com/screenshots_1", "www.example.com/screenshots_2"  
  s.license          = 'MIT'  
  s.author           = { "杜甲" => "dj815319775@163.com" }  
  s.source           = { :git => "https://github.com/jiaoshenmene/GGProject.git", :tag => s.version.to_s }  
  ...
  s.source_files = 'GGProject/GGMainProject/*.{h,m}'  
  # s.resources = 'Assets'  
